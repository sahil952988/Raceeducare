  ...
  return (
    <>
      ...
      <div className=" sm:flex ">
        <div className="left_side sm:w-[50%] 2xl:ml-28 sm:ml-10 ml-5 mr-3">

          <p className='text-[40px] font-bold 2xl:mr-[500px] mb-10 sm:mt-[150px] mt-5 text-white'>We are coming Soon</p>

          <p className='text-[20px] font-semibold xl:mr-[200px] sm:mr-[100px] font-sans text-white'>Welcome to Study in Ireland from Nepal
          ...
          <div className="contact flex space-x-5 mt-5">
            ...
            <div className="email space-x-5 flex">
              <p className='text-[30px] text-white'><i class="fa-solid fa-envelope"></i> </p><p className='sm:text-[16px] text-[12px] text-white mt-3'><i>admissions@studyinireland.info</i></p>
            </div>
          </div>

        </div>

        <div className="right mb-10 mr-5 ml-5">
          <img className='rounded-[8px] sm:w-[500px] sm:mt-[100px] mt-10' src={edu} alt="" />
        </div>
      </div>
    </>
  )
